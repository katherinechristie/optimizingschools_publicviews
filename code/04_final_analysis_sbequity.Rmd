...
insurvey_notprol = setdiff(raw_data$prol_id_clean,
                           prol_dem$participant_id_prolific)
...
raw_data_wp_cleanvar = raw_data_wp %>%
  ...
  ### so that it's actually the attention and  doesnt get aggregated
        ...
        ### various screening
        mutate(is_failattention = case_when(!grepl("Strong agreement", attention_check_q) ~ TRUE, 
                                            is.na(attention_check_q) ~ NA,
                                            TRUE ~ FALSE),
        ...
        timetrad_weeks = 
              ...
              jw_combined = code_agg_scales(raw_data_wp,
              ...
              ### with NA for "prefer not to say" and "mid"
              ...
              ### various flags      
              is_woman = ifelse(sex_prolific == "Female",
                                 TRUE, FALSE),
        
              ### primary definition of minority is non-white
              is_minority = ifelse(!raceeth %in% 
                                c("White",
                                  "Prefer not to say",
                                  "White, Prefer not to say"), TRUE, FALSE),
              
              ### secondary definition is only hispanic or black
              ### for both can select multiple
               is_minority_sec = ifelse(grepl("Hispanic|Black",
                    raceeth), TRUE, FALSE),
